									...
									<TD>
									    <table width="99%" border="0" cellpadding="5" cellspacing="5" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
											  ...
											  <tr align='center' bgcolor="#FFFFFF" height="22">
												  ...
												  <td>
												     <a href="#" onclick="down1('${zuoye.fujian}','${zuoye.fujianYuanshiming}')" style="font-size: 11px;color: red">ä¸‹è½½</a>
												     &nbsp;
												     <a href="<%=path %>/zuoye?type=zuoye_del&id=${zuoye.id}" style="font-size: 11px;color: red">åˆ é™¤</a>
												  </td>
											  </tr>
											  </c:forEach>
				        			    </table>
