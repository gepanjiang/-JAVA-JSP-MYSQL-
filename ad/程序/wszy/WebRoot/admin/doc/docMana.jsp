...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="33" background="<%=path %>/img/tbg.gif">&nbsp;æ•™å­¦èµ„æ–™ç®¡ç†&nbsp;</td>
				</tr>
				<tr align="center" bgcolor="#FAFAF1" height="22">
					<td width="20%">åç§°</td>
					<td width="20%">å†…å®¹</td>
					<td width="20%">é™„ä»¶ä¸‹è½½</td>
					<td width="20%">å‘å¸ƒæ—¶é—´</td>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    <a href="#" onclick="docDetail(${doc.id})" class="pn-loperator">æŸ¥çœ‹å†…å®¹</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a class="pn-loperator" href="<%=path %>/doc?type=docDel&id=${doc.id}">åˆ é™¤</a>
					</td>
				</tr>
				</c:forEach>
			</table>
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 5px;">
			  <tr>
			    <td>
			      <input type="button" value="æ·»åŠ èµ„æ–™" style="width: 80px;" onclick="docAdd()" />
			    </td>
			  </tr>
		    </table>
	</body>
